...
public class BabyNameSettingData
{
    public string BabyNameMP3 = "";
    public string PinYin = "";
}

public class UI_BabyNameSetting : C_BaseUI
{
    [SerializeField]
    ...
    protected override void onOpenUI(params object[] uiObjParams)
    {
        ...
        if (!C_String.CheckStringChinese(PlayerData.BabyName))
        {
        ...
        {
            m_InputField.text = PlayerData.BabyName;
    ...
    private void RequestBabyName()
    {
      ...
      //  form.AddField("uid", PlayerData.UID);
        ...
        {
            C_DebugHelper.Log("UI_BabyNameSetting RequestBabyName result = " + result);
