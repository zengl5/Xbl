...
{
    public static class C_ShadowUtils
    {
        private static List<Vector4> c_Vector4List = new List<Vector4>();
        ...
        public static void SetLightCamera(Camera mainCamera, Camera lightCamera)
        {
            ...
            c_Vector4List.Clear();
            c_Vector4List.Add(vnLeftUp);
            c_Vector4List.Add(vnRightUp);
            c_Vector4List.Add(vnLeftDonw);
            c_Vector4List.Add(vnRightDonw);

            c_Vector4List.Add(vfLeftUp);
            c_Vector4List.Add(vfRightUp);
            c_Vector4List.Add(vfLeftDonw);
            c_Vector4List.Add(vfRightDonw);
            ...
            for (int i = 0; i < c_Vector4List.Count; i++)
            {
                Vector4 v = c_Vector4List[i];
        ...
        public static void SetLightCamera(Bounds b, Camera lightCamera)
        {
            ...
            Vector4 vnLeftUp = lgihtw2v * new Vector3(b.max.x - b.center.x, b.max.y - b.center.y, b.max.z - b.center.z);
            Vector4 vnRightUp = lgihtw2v * new Vector3(b.max.x - b.center.x, b.min.y - b.center.y, b.max.z - b.center.z);
            Vector4 vnLeftDonw = lgihtw2v * new Vector3(b.max.x - b.center.x, b.max.y - b.center.y, b.min.z - b.center.z);
            Vector4 vnRightDonw = lgihtw2v * new Vector3(b.min.x - b.center.x, b.max.y - b.center.y, b.max.z - b.center.z);

            Vector4 vfLeftUp = lgihtw2v * new Vector3(b.min.x - b.center.x, b.min.y - b.center.y, b.min.z - b.center.z);
            Vector4 vfRightUp = lgihtw2v * new Vector3(b.min.x - b.center.x, b.max.y - b.center.y, b.min.z - b.center.z);
            Vector4 vfLeftDonw = lgihtw2v * new Vector3(b.min.x - b.center.x, b.min.y - b.center.y, b.max.z - b.center.z);
            Vector4 vfRightDonw = lgihtw2v * new Vector3(b.max.x - b.center.x, b.min.y - b.center.y, b.min.z - b.center.z);
