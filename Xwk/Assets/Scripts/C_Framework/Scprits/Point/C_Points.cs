...
{
    public class C_Points : MonoBehaviour
    {
        [System.Serializable]
        ...
        public List<C_Point> points = new List<C_Point>();
        ...
        public C_Point GetNextPoint(bool toWorldSpace = true)
        {
        ...
        /// <param name="toWorldSpace">转换到世界坐标</param>
        /// <returns>随机点</returns>
        public C_Point GetRandomPoint(bool toWorldSpace = true)
        {
            if (Count == 0)
                return null;
        ...
        {
            Add(new C_Point(pos, eulerAngles), index);
        }
        ...
        {
            Add(new C_Point(pos, rotation), index);
        }
        ...
        /// 获取世界坐标下的点
        /// </summary>
        public C_Point GetWorldSpacePoint(int index)
        {
