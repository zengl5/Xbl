...
{
    public class NewYearFailState : MonsterBaseState
    {
        private bool showOver = false;

        public NewYearFailState(RoleMgrBase yearMonsterMgrBase) : base(yearMonsterMgrBase)
        {
            showOver = false;
            m_AllowClick = false;
        ...
        {
            base.OnInit();
            PlayAnim("newyeargame/anim/camera/ns_cam03#anim", PlayOver);
        }
